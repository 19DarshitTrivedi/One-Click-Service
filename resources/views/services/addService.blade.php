...
@section('bread-crumb')
<div class="col-sm-12">
    <h3 class="m-0 mt-3 text-muted">Add Service</h3>
...
<div class="col-lg-12">
    <div class="card-box">
        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="e.g : Cleaning" name="servicename" required>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-lg-12">
    <div class="card-box">
        <div class="col-lg-12 mt-3">
            <h6 class="text-muted text-uppercase m-t-0 m-b-20">Add Sub-Services</h6>
            ...
            <tbody>
                <tr>
                    <td>
                        <input type="text" class="form-control" placeholder="e.g : Cleaning" name="subservicename[]" required>
                    </td>
                    <td>
                        <input type="text" class="form-control" placeholder="e.g : 500" name="subserviceprice[]" required>
                    </td>
                    <td>
                        <button class="btn btn-primary" id="sub_service_add">ADD</button>
                    </td>
                </tr>
            </tbody>
            </table>
